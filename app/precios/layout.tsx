...
export const metadata: Metadata = {
  ...
  description: "Planes de BuscayCurra desde 2,99€/mes. Envía CVs automáticamente con IA, accede a 800.000+ ofertas y encuentra trabajo antes que nadie. Sin permanencia.",
  openGraph: {
