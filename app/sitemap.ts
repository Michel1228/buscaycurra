...
import { NOVEDADES } from "@/lib/novedades/contenido";
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // Novedades y campañas: entran solas al añadir una a lib/novedades/contenido.ts.
  const paginasNovedades: MetadataRoute.Sitemap = NOVEDADES.map((n) => ({
    url: `${baseUrl}/novedades/${n.slug}`,
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    ...paginasGuias,
    { url: `${baseUrl}/funciones`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/novedades`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.7 },
    ...paginasNovedades,
