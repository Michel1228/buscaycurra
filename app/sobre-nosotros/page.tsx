...
const HITOS = [
  ...
  { año: "2026", texto: "Superamos 1.900.000 ofertas activas en ${NUM_PAISES} países y 2.400 usuarios activos." },
];
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="mb-16">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { icon: "🔍", titulo: "Busca por ti", desc: "Escanea más de 1.900.000 ofertas en ${NUM_PAISES} países cada 6 horas. Filtra por tu perfil, sector y salario esperado." },
