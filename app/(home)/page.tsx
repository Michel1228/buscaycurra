...
const PAISES = "21";
const PAISES_DATA = [
  { flag: "🇺🇸", nombre: "Estados Unidos", ofertas: "465K" },
  { flag: "🇩🇪", nombre: "Alemania",       ofertas: "400K" },
  { flag: "🇪🇸", nombre: "España",         ofertas: "171K" },
  { flag: "🇫🇷", nombre: "Francia",        ofertas: "128K" },
  { flag: "🇬🇧", nombre: "Reino Unido",    ofertas: "112K" },
  { flag: "🇨🇦", nombre: "Canadá",         ofertas: "86K"  },
  { flag: "🇦🇺", nombre: "Australia",      ofertas: "70K"  },
  { flag: "🇸🇪", nombre: "Suecia",         ofertas: "59K"  },
  { flag: "🇮🇹", nombre: "Italia",         ofertas: "56K"  },
  { flag: "🇳🇱", nombre: "Países Bajos",   ofertas: "41K"  },
  { flag: "🇨🇭", nombre: "Suiza",          ofertas: "39K"  },
...
const planes = [
  {
    ...
    items: ["2 CVs enviados por día", "Mejora de CV con IA", "Búsqueda de ofertas", "Pipeline de candidaturas"],
  ...
  },
  {
    ...
    items: ["60 candidaturas al mes", "Carta personalizada por IA", "Buscador avanzado", "Estadísticas básicas"],
    nota: null,
    destacado: true,
    cta: "Empezar",
    tag: "🔥 Más elegido",
  },
  {
    ...
    items: ["10 CVs enviados por día", "IA avanzada", "Estadísticas detalladas", "Historial completo", "Soporte prioritario"],
    nota: null,
    destacado: false,
    cta: "Empezar",
  },
  {
    ...
    items: ["Envíos ilimitados", "Dashboard de equipo", "API e integraciones", "Soporte 24/7"],
    nota: null,
    destacado: false,
    cta: "Contactar",
  },
...
const superpotencias = [
  ...
  {
    icon: "🎯",
    titulo: "CV único para cada oferta. Cero spam.",
    desc: "Tu CV no se dispara a lo loco. Guzzi lo adapta a cada empresa: palabras clave, formato, tono. Supera los filtros ATS que descartan al 75% de candidatos antes de que un humano lo vea.",
    acento: "#f59e0b",
  },
  {
    icon: "⏰",
    titulo: "Enviado cuando el reclutador está leyendo",
    desc: "Analizamos la hora de actividad de cada empresa. Tu candidatura llega a las 8:32am del martes — no a las 3am de un sábado. La diferencia entre abrirlo o borrarlo sin leer.",
    acento: "#a855f7",
  },
  {
    icon: "🤖",
    titulo: "24/7. No duerme. No se cansa. No se rinde.",
    desc: "Mientras tú vives tu vida, duermes o ves Netflix, Guzzi está escaneando ofertas, adaptando candidaturas y enviando. Como tener un comercial trabajando para ti a tiempo completo.",
    acento: "#e07850",
  },
  {
    icon: "📊",
    titulo: "Pipeline visual: sabes dónde está cada CV",
    desc: "Deja de preguntarte \"¿lo habrán leído?\". Ve en tiempo real el estado de cada candidatura: enviada, abierta, en revisión, entrevista, oferta. Sin agujeros negros.",
    acento: "#3b82f6",
  },
  {
    icon: "💰",
    titulo: "Comparador de salarios reales",
    desc: "¿Cuánto pagan por tu puesto en Berlín vs Barcelona? ¿Merece la pena emigrar? Datos reales de cientos de miles de ofertas. Decide con números, no con intuición.",
    acento: "#f59e0b",
  },
];
...
const testimonios = [
  ...
  },
  {
    ...
    texto: "Me fui a Berlín. Guzzi me encontró ofertas que ni sabía que existían. En 10 días tenía contrato. Sin hablar alemán.",
  },
  {
    nombre: "Ana M.",
    ciudad: "Valencia",
...
const faq = [
  {
    ...
    a: "Sí, completamente. El plan gratuito permite enviar hasta 2 CVs al día con mejora por IA. No pedimos tarjeta de crédito para registrarte. Las funciones avanzadas (60+ envíos/mes, estadísticas, ATS Score) están en los planes de pago — desde 2,99€/mes.",
  },
  {
    q: "¿En cuántos países busca Guzzi?",
    a: `Actualmente en ${PAISES} países: España, Alemania, Reino Unido, Estados Unidos, Canadá, Francia, Suecia, Australia, Países Bajos, Italia, Suiza, Irlanda, Bélgica, Portugal, Noruega, Polonia, Dinamarca, Austria, Finlandia y más. Añadimos países nuevos constantemente.`,
  },
  {
    q: "¿Cómo funciona el envío automático de CVs?",
    a: "Nuestra IA adapta tu CV a cada oferta antes de enviarlo. No es spam — cada candidatura se personaliza con el perfil y palabras clave de la empresa. Tú marcas sector, países y tipo de contrato, y Guzzi trabaja por ti.",
  },
  {
    q: "¿Es legal enviar CVs automáticamente?",
  ...
  {
    q: "¿Puedo buscar trabajo en el extranjero sin hablar el idioma?",
    a: "Sí. Guzzi traduce ofertas a 12 idiomas y adapta tu CV al formato de cada país. Muchas empresas multinacionales trabajan en inglés. Además, si quieres emigrar, te mostramos qué países tienen más demanda de tu perfil y qué salarios ofrecen.",
  },
  {
  ...
  },
  {
    ...
    a: "Sí. El buscador público está disponible sin cuenta. Puedes explorar ofertas por país, salario y sector. Para enviar candidaturas y usar la IA necesitas crear una cuenta — es gratis y tarda 30 segundos.",
  },
  {
    q: "¿En cuánto tiempo puedo encontrar trabajo?",
    a: "La media de nuestros usuarios activos que usan envío automático es de 3 semanas. Con CV bien optimizado y búsqueda en varios países, los usuarios suelen recibir respuesta en 1-2 semanas. Tu caso depende de tu sector y experiencia.",
  },
];
