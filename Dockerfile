...
# ⚠️ Next.js no siempre pilla ENV de Docker — cargamos .env.local explícitamente
RUN export NEXT_PUBLIC_SUPABASE_URL="${NEXT_PUBLIC_SUPABASE_URL}" && \
    ...
    echo "BUILD: SUPABASE_URL=${NEXT_PUBLIC_SUPABASE_URL:0:30}..." && \
    npm run build
